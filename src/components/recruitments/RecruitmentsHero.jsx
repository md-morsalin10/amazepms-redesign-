  ...
  return (
    <section className="relative w-full min-h-[50vh] py-16 flex flex-col items-center justify-center bg-slate-900 overflow-hidden">
      ...
      <div 
        ...
        style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1570126618953-d437176e8c79?q=80&w=2000&auto=format&fit=crop")' }}
      />
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto mt-16">
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight">
            Recruitments & <span className="text-blue-400">Training</span>
          </h1>
        </motion.div>
        ...
        >
          ...
          <span className="text-white font-medium">Recruitments & Training</span>
        </motion.div>
      </div>
    </section>
  );
